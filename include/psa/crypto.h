 ...
 *   #PSA_SIGN_HASH_OPERATION_INIT, for example:
 *   \code
 *   psa_sign_operation_t operation = PSA_SIGN_HASH_OPERATION_INIT;
 *   \endcode
 * - Assign the result of the function psa_sign_hash_operation_init() to
 *   the structure, for example:
 *   \code
 *   psa_sign_operation_t operation;
 *   operation = psa_sign_hash_operation_init();
 *   \endcode
 *
 * This is an implementation-defined \c struct. Applications should not
 * make any assumptions about the content of this structure.
 * Implementation details can change in future versions without notice. */
typedef struct psa_sign_operation_s psa_sign_hash_operation_t;
 ...
 *   \endcode
 * - Initialize the structure to the initializer
 *   #PSA_VERIFY_HASH_OPERATION_INIT, for example:
 *   \code
 *   psa_verify_operation_t operation = PSA_VERIFY_HASH_OPERATION_INIT;
 *   \endcode
 * - Assign the result of the function psa_verify_hash_operation_init() to
 *   the structure, for example:
 *   \code
 *   psa_verify_operation_t operation;
 *   operation = psa_verify_hash_operation_init();
 *   \endcode
 *
 * This is an implementation-defined \c struct. Applications should not
 * make any assumptions about the content of this structure.
 ...
 *
 * \param[in, out] operation    The \c psa_sign_hash_operation_t to use.
 ...
 *         results in this error code.
 */
psa_status_t psa_sign_hash_start( psa_sign_hash_operation_t *operation,
                                  mbedtls_svc_key_id_t key,
                                  psa_algorithm_t alg,
                                  const uint8_t *hash,
                                  size_t hash_length );
 ...
 *
 * \param[in, out] operation    The \c psa_sign_hash_operation_t to use. This
 *                              must be initialized first, and have had \c
 ...
 *         results in this error code.
 */
psa_status_t psa_sign_hash_complete( psa_sign_hash_operation_t *operation,
 ...
 * \p operation structure itself. Once aborted, the operation object
 * can be reused for another operation by calling
 * \c psa_sign_hash_operation_init() again.
 *
 * You may call this function any time after the operation object has
 * been initialized.
 *
 ...
 *         results in this error code.
 */
psa_status_t psa_sign_hash_abort( psa_sign_hash_operation_t *operation );
 ...
 *
 * \param[in, out] operation    The \c psa_verify_hash_operation_t to use. This
 ...
 *         results in this error code.
 */
psa_status_t psa_verify_hash_start( psa_verify_hash_operation_t *operation,
                                    mbedtls_svc_key_id_t key,
                                    psa_algorithm_t alg,
                                    const uint8_t *hash,
                                    size_t hash_length,
 ...
 *         results in this error code.
 */
psa_status_t psa_verify_hash_complete( psa_verify_hash_operation_t *operation );
 ...
 * \p operation structure itself. Once aborted, the operation object
 * can be reused for another operation by calling
 * \c psa_verify_hash_operation_init() again.
 *
 * You may call this function any time after the operation object has
 * been initialized.
 *
 ...
 *         results in this error code.
 */
psa_status_t psa_verify_hash_abort( psa_verify_hash_operation_t *operation );
