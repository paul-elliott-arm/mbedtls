 ...
 *
 */
struct psa_sign_hash_operation_s
{
    size_t MBEDTLS_PRIVATE( num_ops );
};

#define PSA_SIGN_HASH_OPERATION_INIT {0}

static inline struct psa_sign_hash_operation_s psa_sign_hash_operation_init( void )
{
    const struct psa_sign_hash_operation_s v = PSA_SIGN_HASH_OPERATION_INIT;
    return( v );
}
 ...
 *
 */
struct psa_verify_hash_operation_s
{
    size_t MBEDTLS_PRIVATE( num_ops );
};

#define PSA_VERIFY_HASH_OPERATION_INIT {0}

static inline struct psa_verify_hash_operation_s psa_verify_hash_operation_init( void )
{
    const struct psa_verify_hash_operation_s v = PSA_VERIFY_HASH_OPERATION_INIT;
    return( v );
}
